...
icon: home
title: 前言
heroImage: /python_logo.png
bgImage: https://theme-hope-assets.vuejs.press/bg/6-light.svg
bgImageDark: https://theme-hope-assets.vuejs.press/bg/6-dark.svg
bgImageStyle:
  background-attachment: fixed
heroText: 小白0基础学python。
tagline: 这是一本针对0基础小白学习python的书籍。
actions:
  - text: 开始阅读 💡
    link: ./python/
    type: primary
...
copyright: false
footer: 使用 <a href="https://theme-hope.vuejs.press/zh/" target="_blank">VuePress Theme Hope</a> 主题 | MIT 协议, 版权所有 © 2019-present 小白debug
---
